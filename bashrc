...
alias la='LC_ALL=C ls -pa --group-directories-first --time-style=+"%Y-%m-%d %H:%M" --color=auto -F'
alias ll='LC_ALL=C ls -phla --group-directories-first --time-style=+"%Y-%m-%d %H:%M" --color=auto -F'
alias mc='mc -b'
